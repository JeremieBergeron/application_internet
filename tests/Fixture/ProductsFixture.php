...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subcategory_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'quantity_available' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-02 14:25:50',
                'modified' => '2020-11-02 14:25:50',
            ],
        ];
        parent::init();
    }
