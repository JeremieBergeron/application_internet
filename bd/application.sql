...
--
-- Hôte : localhost
-- Généré le : mar. 15 déc. 2020 à 15:57
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `uuid`, `confirmed`, `active`, `adress`, `first_name`, `last_name`, `role_id`, `created`, `modified`) VALUES
(1, 'admin', 'admin@admin.com', '$2y$10$1nnMFVi5ecx9Dqe895zdnuLSAQfyY3D.1pA8kpAH2MMtAUDp44uEO', '79d1e7b7-a337-4748-9a18-ea8f7f213b9d', 0, 1, '2000 Rue de l\'école', 'Jérémie', 'Bergeron', 1, '2020-09-06 13:03:09', '2020-12-15 15:23:14'),
(2, 'manager', 'manager@manager.com', '$2y$10$IH551bVho046lEsiAxG1Zuz0kRPHqpqf3004bCKl8WyeZ5CbwZgSa', '3d3d669d-e981-4965-882b-b796a33bdfcc', 0, 1, '4000 rue de Lamontagne', 'Jean', 'Gagnon', 2, '2020-09-06 13:03:09', '2020-10-03 16:29:53'),
(5, 'customer', 'customer@customer.com', '$2y$10$mRkfW.GsVc9JBxgOATJq0.U6uCvog5QZYrLNZE.NSP6Np6sO.hVYK', '5c2b2551-8efb-4343-b2c3-6759700a1032', 0, 1, '34 Rue de la sagesse', 'Diego', 'Bouchard', 3, '2020-09-06 13:03:09', '2020-10-03 16:29:27'),
(41, 'test', 'jeremiebergeron1515@gmail.com', '$2y$10$ZsXg3YpUBk2pkz/hVn14je47VYt4CFFCAM1lMpTmeKVWn13CBzpOS', '42374759-2d0b-4b84-b5f7-79120085d095', 0, 0, '1867 Rue de Limbourg', 'Jeremie', 'Bergeron', 3, '2020-10-07 18:18:03', '2020-10-07 18:18:03'),
(43, 'test1', 'test1@test.com', '$2y$10$O/Rb.VXxdYQjXdrL/VOCB.HoTHzw8895R1QX5RTgqxQPB3dYAhW1G', '5f3940d5-89be-4c1c-82d5-1b9cfe62c695', 0, 1, 'test1', 'test1', 'test1', 1, '2020-12-07 14:57:12', '2020-12-07 14:57:12'),
(44, 'test2', 'test2@test.com', '$2y$10$o/.YVwOEk0gOIVo2/FiFlO6v9YJZG7bOG5L3xsaxtRnhr35cUzftS', '7b9c5b79-e200-4b61-9d07-47b9393ba850', 0, 1, 'test2', 'test2', 'test2', 1, '2020-12-07 15:03:07', '2020-12-07 15:03:07'),
(45, 'lol', 'testJwt@testJwt.com', '$2y$10$08y4A2FAaCkTSzCX5KypM.zClfbyzNYfnxh9kbcJH6l1jfD3hY4b2', 'f2942a03-c334-4bab-8736-820ab2b9adc0', 0, 1, 'testJwt', 'testJwt', 'testJwt', 1, '2020-12-14 18:30:43', '2020-12-14 18:46:43');
